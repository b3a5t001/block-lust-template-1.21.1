...
public class ModItemTagProvider extends FabricTagProvider.ItemTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup wrapperLookup) {
        ...
        valueLookupBuilder(ItemTags.WOODEN_FENCES)
                ...
                .add(ModPlanks.MOSSY_PALE_OAK_FENCE.asItem())
        ...
        valueLookupBuilder(ItemTags.WOODEN_SLABS)
                ...
                .add(ModPlanks.MOSSY_PALE_OAK_SLAB.asItem())
        ...
        valueLookupBuilder(ItemTags.WOODEN_STAIRS)
                ...
                .add(ModPlanks.MOSSY_PALE_OAK_STAIRS.asItem())
        ...
        valueLookupBuilder(ItemTags.PLANKS)
                ...
                .add(ModPlanks.MOSSY_PALE_OAK_PLANKS.asItem())
